...
#     slice = img[i, :, :]
#     filename = f'top_view/top_view_{i:05d}.pgm'
...
#     segb.append(segmentation.find_boundaries(borders, mode='thick'))
...
for i in range(155):
    ...
    img_path = f'top_view_output/output_{i:05d}.png'
    with Image.open(img_path) as img:
        img_array = np.array(img)

    seg.append(img_array)
